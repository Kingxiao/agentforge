...
RAG_SECURITY_SIGNALS = {
    ...
    "repeated_doc_fetch": "Same document ID retrieved 3+ times",       # Injection content that lures Agent into repeated queries
    "output_length_spike": "Output length > average × 3",         # Injection typically leads to longer output
