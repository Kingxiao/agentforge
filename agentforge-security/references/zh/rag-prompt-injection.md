...
RAG_SECURITY_SIGNALS = {
    ...
    "repeated_doc_fetch": "Same document ID retrieved 3+ times",       # Injection content，吸引 Agent repeatedly querying
    "output_length_spike": "Output length > average × 3",         # Injection通常 leads to longer output
