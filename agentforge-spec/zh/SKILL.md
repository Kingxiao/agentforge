...
> No technical description needed. "帮我自动回复 GitHub Issues", "每天早上读一遍竞品动态发到飞书" are both valid answers.
>
...
> - "能正确处理我们 80% 的 PR，review 质量不比实习生差"
> - "每周省下我 2 小时以上的重复工作"
> - "推给同事用，他们反馈比以前好用"
>
...
| Supply Chain | Is the LLM/API provider stable? Is there a degradation plan? |随时挂 |
...
| **Citation chain tracing** | Trace conclusions back to original sources; reject "二手摘要" | WebFetch for original documents |
