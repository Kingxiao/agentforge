...
Different model families have varying comprehension capabilities and preferences for system prompts. Feeding the same system prompt to all models produces wildly different results.
...
**Key insight**: Different models need different system prompts, not just different parameters. Some models require more explicit tool-call format instructions; some understand XML tags better than Markdown.
